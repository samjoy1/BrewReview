    ...
    <View>
      ...
      <View className="flex-row h-58 w-full bg-yellow-900/90 rounded-xl border border-amber-300/90 mb-6 p-4 shadow-lg">
        <View className="flex-1">
          <BeerCardTextBox
            text={posting_beer ? posting_beer.name : ""}
            placeholder={"Name"}
          />
          <BeerCardTextBox
            text={posting_beer ? posting_beer.category : ""}
            placeholder={"Category"}
          />
          <BeerCardTextBox
            text={posting_beer ? posting_beer.brewery : ""}
            placeholder={"Brewery"}
          />
          <BeerCardTextBox
            text={posting_beer ? posting_beer.country : ""}
            placeholder={"Country"}
          />
