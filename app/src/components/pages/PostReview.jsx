      ...
      >
        ...
        <ScrollView className="relative flex-1">
          <View className="flex-row justify-center mt-4">
            ...
            >
              <Text className="font-bold text-center text-white">Review</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
                navigation.navigate("PostBeer");
              }}
              className={review_rating_button_unselected + " rounded-r-xl"}
            >
              <Text className="font-bold text-center text-black">Beer</Text>
            </TouchableOpacity>
          </View>
          ...
          <View className="p-6 justify-center">
            {type === "review" ? (
              <Text className="bg-zinc-800/90 rounded-xl color-white font-bold text-2xl mb-2 p-3">
                {" "}
                Like a Beer? Post a Review!
              </Text>
            ) : (
              <Text className="bg-zinc-800/90 rounded-xl color-white font-bold text-2xl mb-2 p-3">
                {" "}
                Like a Beer? Leave a Rating!
              </Text>
            )}
            <View className="flex-row justify-center">
              <TouchableOpacity
                ...
                className={
                  type === "review"
                    ? review_rating_button_selected + " rounded-l-xl"
                    : review_rating_button_unselected + " rounded-l-xl"
                }
              >
                <Text
                  className={
              ...
              <TouchableOpacity
                ...
                className={
                  type === "rating"
                    ? review_rating_button_selected + " rounded-r-xl"
                    : review_rating_button_unselected + " rounded-r-xl"
                }
              >
                <Text
                  className={
            ...
            {type === "review" ? (
              <ReviewForm
                posting_user_id={loggedInUser}
                posting_beer={posting_beer}
